    ...
    <div className="flex flex-col min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500/30">
      ...
      <section ref={heroRef} className="relative pt-32 pb-20 md:pt-40 md:pb-32 px-4 md:px-6 min-h-[95vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[80vw] max-w-[800px] max-h-[800px] bg-blue-500/10 blur-[120px] rounded-full pointer-events-none" />
        </div>
