          ...
          <div className="w-full mt-16 mb-6 border-y border-white/5 py-10">
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10 lg:gap-12 px-4">
              <img 
                ...
                alt="Cresol" 
                loading="lazy"
                className="h-20 md:h-28 lg:h-36 object-contain brightness-0 invert transition-transform duration-500 hover:scale-110 cursor-pointer" 
              />
              <img 
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-wrap justify-center items-center gap-12 sm:gap-16 md:gap-24">
            {[
              ...
              { src: "/marcas/renkus-heinz.png", alt: "Renkus-Heinz", w: "w-32 md:w-44", extraClass: "invert mix-blend-screen" },
