    ...
    <div className="flex flex-col min-h-screen bg-[#050505] text-white selection:bg-primary/30">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-4 md:px-6 overflow-hidden">
        ...
        <motion.div className="absolute inset-0 z-0" style={{ y: bgY }}>
          <img fetchPriority="high" src="/auditorio-sonus.jpg" className="w-full h-[120%] object-cover opacity-40 object-[center_60%]" alt="Teatro com iluminação moderna" />
        </motion.div>
          ...
          <div className="space-y-24 md:space-y-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start">
              <FadeIn className="md:sticky md:top-32">
                <div className="rounded-3xl overflow-hidden aspect-[4/3] border border-white/10 relative group shadow-2xl">
                  <img src="https://firebasestorage.googleapis.com/v0/b/sonus-site-ae590.firebasestorage.app/o/projects%2F1779662520044-audiotriounisep.jpg?alt=media&token=d0dd2f7b-6cca-49f1-b120-ce746956cd94" alt="Teatro UNISEP" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 [transform:translateZ(0)]" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start">
              ...
              <FadeIn delay={0.2} className="order-1 md:order-2 md:sticky md:top-32">
                <div className="rounded-3xl overflow-hidden aspect-[4/3] border border-white/10 relative group shadow-2xl">
                  <img src="https://firebasestorage.googleapis.com/v0/b/sonus-site-ae590.firebasestorage.app/o/projects%2F1780178371239-IMG202605301654381.jpg?alt=media&token=b2697a4f-9255-4164-9546-66235231fde8" alt="Auditório CRESOL" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 [transform:translateZ(0)]" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent" />
                  <div className="absolute bottom-6 left-6 right-6">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    ...
                    <Input required id="name" value={formData.name} onChange={(e) => setFormData({...formData, name: e.target.value})} placeholder="Seu Nome" className="bg-black/50 border-white/10 focus-visible:ring-primary h-12 text-white rounded-xl" />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="phone" className="text-sm font-medium text-zinc-300">Telefone / WhatsApp</label>
                    <Input required id="phone" value={formData.phone} onChange={(e) => setFormData({...formData, phone: e.target.value})} placeholder="(11) 90000-0000" className="bg-black/50 border-white/10 focus-visible:ring-primary h-12 text-white rounded-xl" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label htmlFor="email" className="text-sm font-medium text-zinc-300">E-mail Profissional</label>
                  <Input required id="email" type="email" value={formData.email} onChange={(e) => setFormData({...formData, email: e.target.value})} placeholder="seu@empresa.com.br" className="bg-black/50 border-white/10 focus-visible:ring-primary h-12 text-white rounded-xl" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="message" className="text-sm font-medium text-zinc-300">Descreva o escopo do seu Auditório ou Teatro</label>
                  <Textarea required id="message" value={formData.message} onChange={(e) => setFormData({...formData, message: e.target.value})} placeholder="Capacidade de pessoas, problemas atuais, objetivos do projeto..." className="bg-black/50 border-white/10 focus-visible:ring-primary min-h-[150px] resize-none text-white rounded-xl" />
                </div>
