...
export function WarrantyBanner({ title, description, variant = 'default' }: WarrantyBannerProps) {
  ...
  const renderQsys = () => (
    <section className="py-12 md:py-16 border-y border-cyan-500/10 relative overflow-hidden bg-[#020617]">
      ...
      <div className="w-fit mx-auto px-4 sm:px-6 relative z-10">
        <FadeIn className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 text-center md:text-left">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-cyan-100/60 text-lg font-light leading-relaxed text-balance">
  ...
  const renderChurch = () => (
    <section className="bg-[#030201] py-16 md:py-24 border-y border-amber-900/40 relative overflow-hidden">
      ...
      <div className="w-fit mx-auto px-4 sm:px-6 relative z-10">
        <FadeIn className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-10 text-center md:text-left">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-amber-100/70 text-lg md:text-xl font-light leading-relaxed text-balance">
              {description || defaultDesc}
            </p>
          </div>
        </FadeIn>
  ...
  const renderAuditorium = () => (
    <section className="bg-[#020000] py-16 md:py-24 border-y border-red-900/30 relative overflow-hidden group">
      ...
      <div className="w-fit mx-auto px-4 sm:px-6 relative z-10">
        <FadeIn className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-10 text-center md:text-left bg-gradient-to-br from-red-950/40 to-black p-8 md:p-14 rounded-3xl border border-red-900/30 shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
          ...
          <div className="relative z-10 max-w-xl">
            ...
            <p className="text-red-100/60 text-lg md:text-xl font-light leading-relaxed text-balance">
              {description || defaultDesc}
            </p>
          </div>
        </FadeIn>
